...
WIN_FUNC_DECL(KeDeregisterBugCheckReasonCallback, 1)
...
WIN_FUNC_DECL(KeRegisterBugCheckReasonCallback, 4)
...
WIN_FUNC_DECL(ZwPowerInformation, 5)
...
struct wrap_export ntoskernel_exports[] = {
	...
	WIN_SYMBOL(KeDeregisterBugCheckReasonCallback, 1),
	...
	WIN_SYMBOL(KeRegisterBugCheckReasonCallback, 4),
	...
	WIN_SYMBOL(ZwPowerInformation, 5),
	...
	{"KeNumberProcessors", (generic_func)&cpu_count},
