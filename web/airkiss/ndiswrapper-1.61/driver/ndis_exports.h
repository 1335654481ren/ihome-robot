...
WIN_FUNC_DECL(NdisCompletePnPEvent, 3)
...
WIN_FUNC_DECL(NdisMWriteLogData, 3)
...
struct wrap_export ndis_exports[] = {
	...
	WIN_SYMBOL(NdisCompletePnPEvent, 3),
	...
	WIN_SYMBOL(NdisMWriteLogData, 3),
