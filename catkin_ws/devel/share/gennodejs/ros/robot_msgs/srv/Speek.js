...
class SpeekRequest {
  ...
  static serialize(obj, buffer, bufferOffset) {
    // Serializes a message object of type SpeekRequest
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    //deserializes a message object of type SpeekRequest
    let len;
    let data = new SpeekRequest(null);
  ...
  static Resolve(msg) {
    ...
    const resolved = new SpeekRequest(null);
    if (msg.id !== undefined) {
      resolved.id = msg.id;
    }
    else {
...
class SpeekResponse {
  ...
  static serialize(obj, buffer, bufferOffset) {
    // Serializes a message object of type SpeekResponse
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    //deserializes a message object of type SpeekResponse
    let len;
    let data = new SpeekResponse(null);
  ...
  static Resolve(msg) {
    ...
    const resolved = new SpeekResponse(null);
...
module.exports = {
  Request: SpeekRequest,
  Response: SpeekResponse,
  md5sum() { return 'ffe2ed0131a0c7d14cc080adec6a4104'; },
  datatype() { return 'robot_msgs/Speek'; }
};
