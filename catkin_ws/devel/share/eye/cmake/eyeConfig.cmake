...
if("TRUE" STREQUAL "TRUE")
  set(eye_SOURCE_PREFIX /home/renxl/work/samba-share/ihome-robot/catkin_ws/src/ihome/eye)
  set(eye_DEVEL_PREFIX /home/renxl/work/samba-share/ihome-robot/catkin_ws/devel)
  set(eye_INSTALL_PREFIX "")
  set(eye_PREFIX ${eye_DEVEL_PREFIX})
else()
  set(eye_SOURCE_PREFIX "")
  set(eye_DEVEL_PREFIX "")
  set(eye_INSTALL_PREFIX /home/renxl/work/samba-share/ihome-robot/catkin_ws/install)
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      if(NOT IS_DIRECTORY ${include})
        message(FATAL_ERROR "Project 'eye' specifies '${idir}' as an include dir, which is not found.  It does not exist in '${include}'.  ${_report}")
      endif()
    else()
      message(FATAL_ERROR "Project 'eye' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/renxl/work/samba-share/ihome-robot/catkin_ws/src/ihome/eye/${idir}'.  ${_report}")
    endif()
