...
if("TRUE" STREQUAL "TRUE")
  set(eye_SOURCE_PREFIX /home/renxl/share/catkin_ws/src/ihome/eye)
  set(eye_DEVEL_PREFIX /home/renxl/share/catkin_ws/devel)
  set(eye_INSTALL_PREFIX "")
  set(eye_PREFIX ${eye_DEVEL_PREFIX})
else()
  set(eye_SOURCE_PREFIX "")
  set(eye_DEVEL_PREFIX "")
  set(eye_INSTALL_PREFIX /home/renxl/share/catkin_ws/install)
...
if(NOT " " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'eye' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/renxl/share/catkin_ws/src/ihome/eye/${idir}'.  Ask the maintainer 'renxl <renxl@todo.todo>' to fix it.")
    endif()
