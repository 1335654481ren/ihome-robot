...
if("TRUE" STREQUAL "TRUE")
  set(airkiss_SOURCE_PREFIX /home/renxl/work/samba-share/ihome-robot/catkin_ws/src/ihome/airkiss)
  set(airkiss_DEVEL_PREFIX /home/renxl/work/samba-share/ihome-robot/catkin_ws/devel)
  set(airkiss_INSTALL_PREFIX "")
  set(airkiss_PREFIX ${airkiss_DEVEL_PREFIX})
else()
  set(airkiss_SOURCE_PREFIX "")
  set(airkiss_DEVEL_PREFIX "")
  set(airkiss_INSTALL_PREFIX /home/renxl/work/samba-share/ihome-robot/catkin_ws/install)
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      if(NOT IS_DIRECTORY ${include})
        message(FATAL_ERROR "Project 'airkiss' specifies '${idir}' as an include dir, which is not found.  It does not exist in '${include}'.  ${_report}")
      endif()
    else()
      message(FATAL_ERROR "Project 'airkiss' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/renxl/work/samba-share/ihome-robot/catkin_ws/src/ihome/airkiss/${idir}'.  ${_report}")
    endif()
